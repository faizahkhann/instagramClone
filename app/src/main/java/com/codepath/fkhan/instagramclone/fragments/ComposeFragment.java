...
import com.codepath.fkhan.instagramclone.MainActivity;
import com.codepath.fkhan.instagramclone.Post;
import com.codepath.fkhan.instagramclone.R;
...
public class ComposeFragment extends Fragment {
    ...
    // either dynamically or via XML layout inflation. we set up which layoutfile should be used for the gfragment
    @Override
    ...
    // Any view setup should occur here.  E.g., view lookups and attaching view listeners. (set up all views)
    @Override
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                ...
                photo.setImageBitmap(takenImage); //ivPostImage
